...
var middleware = function (req, res, next) {
  ...
  try {
    ...
    console.log('middleware caught an err...');
...
OAuth._renderOauthResults = function(res, query, credentialSecret) {
  process.env.DEBUG && console.log('OAuth._renderOauthResults')
...
OAuth._requestHandlers['2'] = function (service, query, res) {
  process.env.DEBUG && console.log("OAuth._requestHandlers['2']", service)
  ...
  if (!query.error) {
    ...
    process.env.DEBUG && console.log("OAuth._requestHandlers['2'].oauthResult", oauthResult)
